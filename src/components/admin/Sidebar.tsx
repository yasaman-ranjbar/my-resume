        ...
        items: [
            ...
            },
            {
                ...
                submenu: [
                    ...
                    { title: "Add Post", href: "/admin/pages/new" }
                ]
            },
        ...
        items: [
            {
                ...
                icon: Table,
                submenu: [
                    { title: "Data Tables", href: "/admin/tables" }
                ]
            },
        ]
    }
...
const SidebarItem = ({ item }: { item: MenuItem }) => {
    ...
    return (
        <li className="mb-1">
            <div
                className={`rounded-t-xl flex items-center justify-between px-4 py-3 cursor-pointer transition-colors hover:bg-gray-200 ${isOpen ? 'bg-[#F5F7FB]' : ''}`}
