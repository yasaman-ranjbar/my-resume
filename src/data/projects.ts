...
export const projects: Project[] = [
  {
    ...
    description: 'A comprehensive e-commerce solution built with Next.js and Stripe integration. Features include product filtering, user authentication, and a seamless checkout process.',
    technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Stripe', 'Zustand'],
    demoLink: '#',
    githubLink: '#',
    challenges: ['Handling complex state management for the cart', 'Optimizing image loading for product grids'],
    solutions: ['Implemented Zustand for global state', 'Used Next.js Image component with blur placeholders'],
  ...
  },
  {
    ...
    description: 'A real-time task management application allowing teams to create, assign, and track tasks. Includes drag-and-drop functionality and real-time updates.',
  ...
  },
  {
    ...
    description: 'A beautiful weather dashboard that displays current conditions and forecasts for cities worldwide. Uses external APIs to fetch live data.',
