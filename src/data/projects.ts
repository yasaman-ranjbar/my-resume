...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "A full-featured online store with cart and checkout.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "A collaborative tool for teams to track progress.",
    description:
    ...
    challenges: [
      ...
      "Drag and drop performance on mobile",
    ],
    solutions: [
      "Utilized Firebase Firestore listeners",
      "Optimized touch events for DnD Kit",
    ],
    screenshots: [
      "/placeholder-3.jpg",
      "/placeholder-4.jpg",
